...
class CUB200(Dataset):
    ...
    def _pre_operate(self, root):
        ...
        split_file = root + '/CUB_200_2011/train_test_split.txt'
        class_file = root + '/CUB_200_2011/image_class_labels.txt'
...
if __name__ == '__main__':
    ...
    trainloader = torch.utils.data.DataLoader(dataset=trainset, batch_size=batch_size_base, shuffle=True, num_workers=args.num_workers,
                                              pin_memory=True)
